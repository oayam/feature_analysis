...
declare interface NavigationConfiguration {
   ...
   *
   * <br>Limits the maximum number of active page nodes in the Navigation page stack.
   * <br>When the limit is exceeded, the oldest page nodes are automatically destroyed
   * in FIFO (First-In-First-Out) order.
   * <br>NavPathInfo of pages is completely retained, supporting page recreation.
   * <br>Default value: **0**, indicating no limit.
   * <br>**value <= 0**: No limit on page stack size.
   * <br>**value > 0**: Limit stack size to the specified value.
   *
   * @type { ?int }
   * @default 0
   * @syscap SystemCapability.ArkUI.ArkUI.Full
